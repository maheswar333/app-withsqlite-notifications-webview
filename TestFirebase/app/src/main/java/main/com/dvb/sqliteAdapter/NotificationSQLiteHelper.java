...
public class NotificationSQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "NotificationsDataBase";
    public static final String TABLE_NAME = "Notification";
    public static final String COLUMN_ID = "id";
    public static final String COLUMN_NOTIID = "notiid";
...
//                " VARCHAR);";
    ...
    public boolean addNotification(int id ,String subject, String date, String details){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_NOTIID,id);
